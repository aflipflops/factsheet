...
```{r historical data,include=FALSE,echo=FALSE,results='hide',message=FALSE,purl=FALSE}
...
##### CO2 Emissions
```{r co2 emissions,message=FALSE,warning=FALSE,error=FALSE,purl=FALSE,error=FALSE, warning=FALSE, purl=FALSE,message=FALSE}
...
```{r Elec|Efficiency,include=FALSE}
...
```
#### Efficiency of coal to electricity conversion
```{r}
whole_pe_coal_elec <- whole[whole$variable=="Primary Energy|Coal|Electricity" ,] %>% 
  arrange(model,scenario)
whole_se_coal_elec <- whole[whole$variable=="Secondary Energy|Electricity|Coal|w/o CCS" & whole$model!="COPPE-COFFEE 1.0",] %>% 
  arrange(model,scenario)
