...
ggsave(file="CO2emi_CHN.png",width=8,height=4)
...
ggplot()+
  ...
  geom_line(data=plot1a,aes(x=period,y=value/1000,group=model,linetype=model),color="grey")+
  geom_line(data=plot2,aes(x=period,y=value/1000,group=modscen,color=modscen))+
  theme_bw()+ylab("CO2 Emissions Electricity (Gt/yr)")+xlab("year")+xlim(2000,2050)+ylim(-1.5,6)
ggsave(file="CO2emi_elec_CHN.png",width=8,height=4)
...
ggplot()+
  ...
  theme_bw()+ylab("Final Energy Electricity (EJ/yr)")+xlab("year")+xlim(2000,2050)+ylim(0,65)
ggsave(file="FEelec_CHN.png",width=8,height=4)
...
scale_fill_manual(values=plotstyle(plotvar))  + xlab("Model - Scenario")+
  geom_text(data=plot1,aes(x=modscen,y=60,label=modscen,angle=90,hjust="right"),color="red",size=2.5)+
  geom_point(data=plot2,aes(x=modscen,y=value))+ylim(0,60)+
  theme_bw()+ylab("Secondary Energy Electricity (EJ/yr)")
ggsave(file="SEelec_CHN.png",width=8,height=5)
...
ggplot()+
  geom_bar(data=plot1,aes(x=modscen,y=value/1,group=interaction(modscen,variable),fill=variable),stat="identity")+
  scale_fill_manual(values=plotstyle(plotvar))  + xlab("Model - Scenario")+
  geom_text(data=plot1,aes(x=modscen,y=5000,label=modscen,angle=90,hjust="right"),color="red",size=2.5)+
  geom_point(data=plot2,aes(x=modscen,y=value))+ylim(0,5000)+
  theme_bw()+ylab("Power Capacity (GW)")
ggsave(file="Capacity_CHN.png",width=8,height=5)
